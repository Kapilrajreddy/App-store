...
class AppStore extends Component {
  ...
  filteredApp = searchResults => {
    const {activeTabId} = this.state
    const filteredApp = searchResults.filter(
  ...
  render() {
    ...
    const searchResults = this.getResults(searchInput)
    const filteredApps = this.filteredApp(searchResults)
    return (
      <div className="app-store-main-container">
        <div className="app-store-sub-container">
          <h1 className="app-store-main-heading">App Store</h1>
          ...
          <ul className="app-store-tab-item-container">
          ...
          <ul className="app-store-app-list-container">
            {filteredApps.map(eachApp => (
              <AppItem appDetails={eachApp} />
            ))}
          </ul>
        </div>
      </div>
